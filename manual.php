										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="procie" id="procie" placeholder="Type in watt">
												</div>
											</div>
											<div class="col-md-6"> 
												<div class="form-group">
													<label class="label" for="gpu">Graphic Card</label>
													<input type="text" class="form-control" name="gpu" id="gpu" placeholder="Type in watt">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="label" for="mobo">Motherboard</label>
													<input type="text" class="form-control" name="mobo" id="mobo" placeholder="Type in watt">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="label" for="cooler">Cooler</label>
													<input type="text" class="form-control" name="cooler" id="cooler" placeholder="Type in watt">
												</div>
											</div>
                                            <div class="col-md-12">
												<div class="form-group">
													<label class="label" for="monitor">Monitor</label>
													<input type="text" class="form-control" name="monitor" id="monitor" placeholder="Type in watt">
												</div>
											</div>
                                            <div class="col-md-12">
												<div class="form-group">
													<label class="label" for="ram">RAM</label>
													<input type="text" class="form-control" name="ram" id="ram" placeholder="Type in watt">
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
