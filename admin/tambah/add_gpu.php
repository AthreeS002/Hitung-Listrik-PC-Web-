            ...
            <div class="col-md-8">
              ...
              <div class="card card-info">
                ...
                <?php
                  ...
                  ?>
                <form action="adding_gpu.php" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                  <!-- <h5 class="card-title">You can add data GPU</h5> -->
                    <hr>
                    <div class="form-group">
                      <label for="">Name</label>
                      <input type="text" name="nama_gpu" class="form-control">
                    </div>
                    <div class="form-group">
                      <label for="">TDP</label>
                      <input type="number" name="tdp_gpu" class="form-control">
                    </div>

                    <!-- /.card-body -->

                    <div class="card-footer text-center">
                      <a href="tamu.php" name="batal" class="btn btn-danger">Cancel</a>
                      &nbsp;
